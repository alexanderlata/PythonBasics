...
* Решите уравнение
    * $x^5-15x^4+57x^3-13x^2+26x=112$
    * $(x^2+3x+1)^2+10=-2(x^2+3x-4)$
    * $(x^2-1)(x^2-10x+13)=2x(x^2-10x+13)$
    * $\displaystyle \frac{(2x-1)(x-6)(x^2-5x+14)(x+1)}{x^5-15x^4+57x^3-13x^2+26x+112}=0$
* Методом Гаусса приведите систему линейных уравнений к ступенчатому виду. Какие переменные являются базисными? Решите данную систему уравнений.
    * $$\begin{cases}
    ...
    * $$
      \begin{cases}
      x_1-2x_2-x_3+3x_4=5, \\
      2x_1-4x_2-3x_3+6x_4=10, \\
      3x_1-8x_2-6x_3+11x_4=11, \\
